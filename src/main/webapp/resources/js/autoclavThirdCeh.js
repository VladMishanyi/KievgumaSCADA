...
let vTitle = 'Объект/Киевгума/3й Цех/Автоклав'+' с '+vStart.toString()+' по '+vEnd.toString();
...
function generateNewChartTitle(start, end) {
    config.options.title.text = 'Объект/Киевгума/3й Цех/Автоклав'+' с '+start.toString()+' по '+end.toString();
}
