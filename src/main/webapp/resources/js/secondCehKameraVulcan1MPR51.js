...
function connect() {
    ...
    stompClient.connect({}, function(frame) {
        ...
        stompClient.subscribe('/topic/generateChartSecondCehKameraVulcan1MPR51', function(result){
        ...
        stompClient.subscribe('/topic/secondCehKameraVulcan1MPR51_device1', function(result){
            ...
            document.getElementById("secondCehKameraVulcan1MPR51Kanal2").value = register45;
...
function generateNewChartTitle(start, end) {
    config.options.title.text = 'Объект/Киевгума/2й Цех/Камера вулканизации1'+' с '+start.toString()+' по '+end.toString();
}
