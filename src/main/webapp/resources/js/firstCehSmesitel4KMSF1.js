...
function connect() {
    ...
    stompClient.connect({}, function(frame) {
        ...
        stompClient.subscribe('/topic/generateChartFirstCehSmesitel4KMSF1', function(result){
...
var vTitle = 'Объект/Киевгума/1й Цех/Смеситель_4'+' с '+vStart.toString()+' по '+vEnd.toString();
...
function generateNewChartTitle(start, end) {
    config.options.title.text = 'Объект/Киевгума/1й Цех/Смеситель_4'+' с '+start.toString()+' по '+end.toString();
}
...
function sendChartBody() {
    ...
    stompClient.send("/app/generateChartFirstCehSmesitel4KMSF1", {}, dataChart);
}
...
function showBody(body){
    ...
    $("#firstCehSmesitel4Tok").text(channel1);
    $("#firstCehSmesitel4Temp").text(channel2);
    $("#firstCehSmesitel4Pressure").text(channel3);
}
