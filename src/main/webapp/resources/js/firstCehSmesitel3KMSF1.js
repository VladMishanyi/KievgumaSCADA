...
function connect() {
    ...
    stompClient.connect({}, function(frame) {
        ...
        stompClient.subscribe('/topic/generateChartFirstCehSmesitel3KMSF1', function(result){
...
let vTitle = 'Объект/Киевгума/1й Цех/Смеситель_3'+' с '+vStart.toString()+' по '+vEnd.toString();
...
function showBody(body){
    ...
    $("#firstCehSmesitel3Tok").text(channel1);
    $("#firstCehSmesitel3Temp").text(channel2);
