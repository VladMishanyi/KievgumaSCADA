...
function connect() {
    ...
    stompClient.connect({}, function(frame) {
        ...
        stompClient.subscribe('/topic/table-model-air-sensor2', function(resultTrm){
        ...
        stompClient.subscribe('/topic/generate-chart-air-sensor2', function(result){
...
let vTitle = 'Обєкт/Київгума/Сенсор повітря2'+' з '+vStart.toString()+' по '+vEnd.toString();
...
function generateNewChartTitle(start, end) {
    config.options.title.text = 'Обєкт/Київгума/Сенсор повітря2'+' з '+start.toString()+' по '+end.toString();
}
...
function sendChartBody() {
    ...
    stompClient.send("/app/generate-chart-air-sensor2", {}, dataChart);
}
