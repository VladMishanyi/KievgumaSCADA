...
let vTitle = 'Объект/Киевгума/1й Цех/Смеситель_1'+' с '+vStart.toString()+' по '+vEnd.toString();
...
function generateNewChartTitle(start, end) {
    config.options.title.text = 'Объект/Киевгума/1й Цех/Смеситель_1'+' с '+start.toString()+' по '+end.toString();
}
