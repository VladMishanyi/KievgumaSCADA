...
function connect() {
    ...
    stompClient.connect({}, function(frame) {
        ...
        stompClient.subscribe('/topic/generateLaboratoryAutoklav', function(result){
...
let vTitle = 'Объект/Киевгума/Лаборатория/Автоклав'+' с '+vStart.toString()+' по '+vEnd.toString();
...
function showBody(body){
    ...
    $("#realAutoclavLaboratoryTemperaturaValue").text(channel1);
