...
function connect() {
    ...
    stompClient.connect({}, function(frame) {
        ...
        stompClient.subscribe('/topic/generateChartFirstCehSmesitel5KMSF1', function(result){
...
var vTitle = 'Объект/Киевгума/1й Цех/Смеситель_5'+' с '+vStart.toString()+' по '+vEnd.toString();
...
function generateNewChartTitle(start, end) {
    config.options.title.text = 'Объект/Киевгума/1й Цех/Смеситель_5'+' с '+start.toString()+' по '+end.toString();
}
...
function sendChartBody() {
    ...
    stompClient.send("/app/generateChartFirstCehSmesitel5KMSF1", {}, dataChart);
}
...
function showBody(body){
    ...
    $("#firstCehSmesitel5Tok").text(channel1);
    $("#firstCehSmesitel5Temp").text(channel2);
    $("#firstCehSmesitel5Pressure").text(channel3);
}
