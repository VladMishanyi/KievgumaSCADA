...
function connect() {
    ...
    stompClient.connect({}, function(frame) {
        ...
        stompClient.subscribe('/topic/generateChartFirstCehAutoklav', function(result){
...
function generateNewChartTitle(start, end) {
    config.options.title.text = 'Объект/Киевгума/1й Цех/Автоклав'+' с '+start.toString()+' по '+end.toString();
}
