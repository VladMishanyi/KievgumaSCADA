...
let vTitle = 'Объект/Киевгума/2й Цех/Линия напальчников'+' с '+vStart.toString()+' по '+vEnd.toString();
...
function showBody(body){
    ...
    let channel3 = body.inputRegister2;
    let channel4 = body.inputRegister3;
    let channel5 = body.inputRegister4;
...
function drawInRealTime(parsed) {
    ...
    let y3 = parsed.inputRegister2;
    let y4 = parsed.inputRegister3;
    let y5 = parsed.inputRegister4;
