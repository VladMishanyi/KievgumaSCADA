...
function connect() {
    ...
    stompClient.connect({}, function(frame) {
        ...
        stompClient.subscribe('/topic/generateChartSevenCehAutoclav', function(result){
...
let vTitle = 'Объект/Киевгума/7й Цех/Автоклав'+' с '+vStart.toString()+' по '+vEnd.toString();
...
function generateNewChartTitle(start, end) {
    config.options.title.text = 'Объект/Киевгума/7й Цех/Автоклав'+' с '+start.toString()+' по '+end.toString();
}
...
function sendChartBody() {
    ...
    stompClient.send("/app/generateChartSevenCehAutoclav", {}, dataChart);
}
...
function showBody(body){
    ...
    $("#sevenCehAutoclavDavlenie").text(channel1);
    $("#sevenCehAutoclavTempAuto").text(channel2);
    $("#sevenCehAutoclavTempProdukta").text(channel3);
}
