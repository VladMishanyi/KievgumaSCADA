...
let vTitle = 'Объект/Киевгума/Отдел ГЭ/Температура помещения'+' с '+vStart.toString()+' по '+vEnd.toString();
...
function showBody(body){
    let channel0 = body.holdingRegister0;
    let channel1 = body.holdingRegister1;
