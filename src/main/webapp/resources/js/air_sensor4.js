...
function connect() {
    ...
    stompClient.connect({}, function(frame) {
        ...
        stompClient.subscribe('/topic/table-model-air-sensor4', function(resultTrm){
        ...
        stompClient.subscribe('/topic/generate-chart-air-sensor4', function(result){
...
let vTitle = 'Обєкт/Київгума/Сенсор повітря4'+' з '+vStart.toString()+' по '+vEnd.toString();
...
function generateNewChartTitle(start, end) {
    config.options.title.text = 'Обєкт/Київгума/Сенсор повітря4'+' з '+start.toString()+' по '+end.toString();
}
...
function sendChartBody() {
    ...
    stompClient.send("/app/generate-chart-air-sensor4", {}, dataChart);
}
