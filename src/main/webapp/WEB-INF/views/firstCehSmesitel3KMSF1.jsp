...
<head>
    ...
    <title>Smesitel3 First Department</title>
    ...
    <div class="container">
        ...
        <table class="table">
            <tr>
                ...
                <th><span id="firstCehSmesitel3Tok" style="color: red; font-family: sans-serif; font-size: 24px;"> </span> А</th>
            </tr>
            <tr>
                <th><span style="color: black; font-family: sans-serif; font-size: 24px;">Реальное значение температуры</span></th>
                <th><span id="firstCehSmesitel3Temp" style="color: red; font-family: sans-serif; font-size: 24px;"> </span> град.</th>
            </tr>
            <tr>
                <th><span style="color: black; font-family: sans-serif; font-size: 24px;">Реальное значение давления</span></th>
                <th><span id="firstCehSmesitel3Pressure" style="color: red; font-family: sans-serif; font-size: 24px;"> </span> бар.</th>
            </tr>
        </table>
        <div class="row">
...
<%--//        var y2 = Array();--%>
        ...
        <%--$.ajax({--%>
            ...
            <%--url: "/generateChartFirstCehSmesitel3KMSF1",--%>
...
<%--//        context.clearShadow();--%>
    ...
    <%--function buildChart(xCord, y1Cord, y2Cord, y3Cord) {--%>
        ...
        <%--var vTitle = 'Объект/Киевгума/1й Цех/Смеситель_3'+' с '+start.toString()+' по '+end.toString();--%>
...
<%--<script type="text/javascript">--%>
    ...
    <%--function connect() {--%>
        ...
        <%--stompClient.connect({}, function(frame) {--%>
            ...
            <%--stompClient.subscribe('/topic/firstCehSmesitel3KMSF1', function(resultTrm){--%>
    ...
    <%--function showTrmBody(trmBody){--%>
        ...
        <%--$("#firstCehSmesitel3Tok").text(temp1);--%>
        <%--$("#firstCehSmesitel3Temp").text(temp2);--%>
        <%--$("#firstCehSmesitel3Pressure").text(temp3);--%>
    <%--}--%>
<%--</script>--%>
<%--<script rel="script" type="text/javascript">--%>
...
<script rel="script" type="text/javascript" src="<c:url value="/resources/js/firstCehSmesitel3KMSF1.js"/>"></script>
</body>
</html>
