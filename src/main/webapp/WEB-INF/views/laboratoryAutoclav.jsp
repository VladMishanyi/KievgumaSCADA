...
<head>
    ...
    <title>Autoclav Laboratory</title>
    ...
    <div class="container">
        ...
        <table class="table">
            <tr>
                ...
                <th><span id="realAutoclavLaboratoryTemperaturaValue" style="color: red; font-family: sans-serif; font-size: 24px;"> </span> град.</th>
            </tr>
            <tr>
                <th><span style="color: black; font-family: sans-serif; font-size: 24px;">Реальное значение давления</span></th>
                <th><span id="realAutoclavLaboratoryDavlenieValue" style="color: red; font-family: sans-serif; font-size: 24px;"> </span> бар.</th>
            </tr>
        </table>
        <div class="row">
...
<%--//        clearChart();--%>
        ...
        <%--$.ajax({--%>
            ...
            <%--url: "/generateLaboratoryAutoklav",--%>
...
<%--//        context.clearShadow();--%>
    ...
    <%--function buildChart(xCord, y1Cord, y2Cord) {--%>
        ...
        <%--var vTitle = 'Объект/Киевгума/Лаборатория/Автоклав'+' с '+start.toString()+' по '+end.toString();--%>
...
<%--<script type="text/javascript">--%>
    ...
    <%--function connect() {--%>
        ...
        <%--stompClient.connect({}, function(frame) {--%>
            ...
            <%--stompClient.subscribe('/topic/laboratoryAvtoclav', function(resultTrm){--%>
    ...
    <%--function showTrmBody(trmBody){--%>
        <%--var tempFormat = Math.round(trmBody.channel1 * 100)/100;--%>
        <%--var davlenieFormat = Math.round(trmBody.channel2 * 100)/100;--%>
        <%--$("#realAutoclavLaboratoryTemperaturaValue").text(tempFormat);--%>
...
<script rel="script" type="text/javascript" src="<c:url value="/resources/js/laboratoryAutoclav.js"/>"></script>
</body>
</html>
