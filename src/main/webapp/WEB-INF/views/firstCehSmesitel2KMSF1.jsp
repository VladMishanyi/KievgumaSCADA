...
<head>
    ...
    <title>Smesitel2 First Department</title>
    ...
    <div class="container">
        ...
        <table class="table">
            <tr>
                ...
                <th><span id="firstCehSmesitel2Tok" style="color: red; font-family: sans-serif; font-size: 24px;"> </span> А</th>
            </tr>
            <tr>
...
<%--//        var y2 = Array();--%>
        ...
        <%--$.ajax({--%>
            ...
            <%--url: "/generateChartFirstCehSmesitel2KMSF1",--%>
...
<%--//        context.clearShadow();--%>
    ...
    <%--function buildChart(xCord, y1Cord, y2Cord, y3Cord) {--%>
        ...
        <%--var vTitle = 'Объект/Киевгума/1й Цех/Смеситель_2'+' с '+start.toString()+' по '+end.toString();--%>
...
<script rel="script" type="text/javascript" src="<c:url value="/resources/js/firstCehSmesitel2KMSF1.js"/>"></script>
</body>
</html>
