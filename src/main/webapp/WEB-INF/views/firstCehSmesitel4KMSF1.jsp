...
<head>
    ...
    <title>Smesitel4 First Department</title>
    ...
    <div class="container">
        ...
        <table class="table">
            <tr>
                ...
                <th><span id="firstCehSmesitel4Tok" style="color: red; font-family: sans-serif; font-size: 24px;"> </span> А</th>
            </tr>
            <tr>
                <th><span style="color: black; font-family: sans-serif; font-size: 24px;">Реальное значение температуры</span></th>
                <th><span id="firstCehSmesitel4Temp" style="color: red; font-family: sans-serif; font-size: 24px;"> </span> град.</th>
            </tr>
            <tr>
...
<%--//        var y2 = Array();--%>
        ...
        <%--$.ajax({--%>
            ...
            <%--url: "/generateChartFirstCehSmesitel4KMSF1",--%>
...
<%--//        context.clearShadow();--%>
    ...
    <%--function buildChart(xCord, y1Cord, y2Cord, y3Cord) {--%>
        ...
        <%--var vTitle = 'Объект/Киевгума/1й Цех/Смеситель_4'+' с '+start.toString()+' по '+end.toString();--%>
...
<%--<script type="text/javascript">--%>
    ...
    <%--function connect() {--%>
        ...
        <%--stompClient.connect({}, function(frame) {--%>
            ...
            <%--stompClient.subscribe('/topic/firstCehSmesitel4KMSF1', function(resultTrm){--%>
    ...
    <%--function showTrmBody(trmBody){--%>
        ...
        <%--$("#firstCehSmesitel4Tok").text(temp1);--%>
        <%--$("#firstCehSmesitel4Temp").text(temp2);--%>
        <%--$("#firstCehSmesitel4Pressure").text(temp3);--%>
    <%--}--%>
<%--</script>--%>
<%--<script rel="script" type="text/javascript">--%>
...
<script rel="script" type="text/javascript" src="<c:url value="/resources/js/firstCehSmesitel4KMSF1.js"/>"></script>
</body>
</html>
