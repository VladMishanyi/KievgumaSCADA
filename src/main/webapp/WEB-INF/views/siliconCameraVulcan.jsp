...
<head>
    ...
    <title>Silicon camera vulcan</title>
                    ...
                    <td>
                        <div>
                            <div>
                                ...
                                <a href="/" id="back" class="btn btn-sm btn-success" onclick="disconnect();" > Назад</a>
...
<script rel="script" type="text/javascript" src="<c:url value="/resources/js/siliconCameraVulcan.js"/>"></script>
</body>
</html>
