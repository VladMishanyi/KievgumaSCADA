...
<head>
    ...
    <title>Energetik Department</title>
    ...
    <div class="container">
        ...
        <table class="table">
            <tr>
                ...
                <th><span id="realTrmValue" style="color: red; font-family: sans-serif; font-size: 24px;"> </span> град.</th>
            </tr>
            <tr>
                <th><span style="color: black; font-family: sans-serif; font-size: 24px;">Реальное значение температуры2</span></th>
...
<%--//        context.clearShadow();--%>
    ...
    <%--function buildChart(xCord, yCord) {--%>
        ...
        <%--var vTitle = 'Объект/Киевгума/Отдел ГЭ/Температура помещения'+' с '+start.toString()+' по '+end.toString();--%>
...
<%--<script type="text/javascript">--%>
    ...
    <%--function showTrmBody(trmBody){--%>
        <%--var tempFormat = Math.round(trmBody.value3 * 100)/100;--%>
        <%--$("#realTrmValue").text(tempFormat);--%>
    <%--}--%>
<%--</script>--%>
<%--<script rel="script" type="text/javascript">--%>
...
<script rel="script" type="text/javascript" src="<c:url value="/resources/js/otdel_energetika.js"/>"></script>
</body>
</html>
