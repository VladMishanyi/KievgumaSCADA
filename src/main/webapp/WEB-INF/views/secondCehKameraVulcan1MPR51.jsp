...
<head>
    ...
    <title>Kamera Vulkan1 Second Department</title>
    ...
    <div class="container">
        ...
        <table class="table">
            <%--<tr>--%>
                ...
                <%--<th><span id="secondCehKameraVulcan1MPR51Kanal1" style="color: red; font-family: sans-serif; font-size: 24px;"> </span> град.</th>--%>
            <%--</tr>--%>
            <tr>
                <th><span style="color: black; font-family: sans-serif; font-size: 24px;">Реальное значение температуры</span></th>
                <th><span id="secondCehKameraVulcan1MPR51Kanal2" style="color: red; font-family: sans-serif; font-size: 24px;"> </span> град.</th>
            </tr>
            <%--<tr>--%>
                <%--<th><span style="color: black; font-family: sans-serif; font-size: 24px;">Реальное значение температуры на канал3</span></th>--%>
                <%--<th><span id="secondCehKameraVulcan1MPR51Kanal3" style="color: red; font-family: sans-serif; font-size: 24px;"> </span> град.</th>--%>
            <%--</tr>--%>
        </table>
...
<script rel="script" type="text/javascript" src="<c:url value="/resources/js/secondCehKameraVulcan1MPR51.js"/>"></script>
</body>
</html>
