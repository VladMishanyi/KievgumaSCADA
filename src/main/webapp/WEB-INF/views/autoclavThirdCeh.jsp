...
//        clearChart();
        ...
        $.ajax({
            ...
            url: "/generateChartThirdCehAutoklav",
...
<script type="text/javascript">
    ...
    function showTrmBody(trmBody){
        ...
        $("#realAutoclavThirdCehTemperaturaValue").text(tempFormat);
        $("#realAutoclavThirdCehDavlenieValue").text(davlenieFormat);
    }
</script>
<script rel="script" type="text/javascript">
