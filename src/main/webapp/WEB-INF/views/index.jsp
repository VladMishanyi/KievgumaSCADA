...
<div id="main">
    ...
    <a id="sensor3-style" class='btn btn-sm btn-success btn--shockwave is-active' href="/sensor3">
        Сенсор3
    </a>
    <a id="sensor4-style" class='btn btn-sm btn-success btn--shockwave is-active' href="/sensor4">
        Сенсор4
    </a>
