...
<head>
    ...
    <title>Autoclav First Department</title>
    ...
    <div class="container">
        ...
        <table class="table">
            <tr>
                ...
                <th><span id="realAutoclavFirstCehTemperaturaValue" style="color: red; font-family: sans-serif; font-size: 24px;"> </span> град.</th>
            </tr>
            <tr>
                <th><span style="color: black; font-family: sans-serif; font-size: 24px;">Реальное значение давления</span></th>
                <th><span id="realAutoclavFirstCehDavlenieValue" style="color: red; font-family: sans-serif; font-size: 24px;"> </span> бар.</th>
            </tr>
        </table>
        <div class="row">
...
//        clearChart();
        ...
        $.ajax({
            ...
            url: "/generateChartFirstCehAutoklav",
...
//        context.clearShadow();
    ...
    function buildChart(xCord, y1Cord, y2Cord) {
        ...
        var vTitle = 'Объект/Киевгума/1й Цех/Автоклав'+' с '+start.toString()+' по '+end.toString();
...
<script type="text/javascript">
    ...
    function showTrmBody(trmBody){
        ...
        $("#realAutoclavFirstCehTemperaturaValue").text(tempFormat);
        $("#realAutoclavFirstCehDavlenieValue").text(davlenieFormat);
    }
</script>
<script rel="script" type="text/javascript">
