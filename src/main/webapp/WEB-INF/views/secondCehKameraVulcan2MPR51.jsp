    ...
    <div class="container">
        ...
        <table class="table">
            <%--<tr>--%>
                ...
                <%--<th><span id="secondCehKameraVulcan2MPR51Kanal1" style="color: red; font-family: sans-serif; font-size: 24px;"> </span> град.</th>--%>
            <%--</tr>--%>
            <tr>
            ...
            <%--<tr>--%>
                ...
                <%--<th><span id="secondCehKameraVulcan2MPR51Kanal3" style="color: red; font-family: sans-serif; font-size: 24px;"> </span> град.</th>--%>
            <%--</tr>--%>
        </table>
