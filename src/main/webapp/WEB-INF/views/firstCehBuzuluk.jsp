...
//        clearChart();
        ...
        $.ajax({
            ...
            url: "/generateChartFirstCehBuzuluk",
...
//        context.clearShadow();
    ...
    function buildChart(xCord, y1Cord, y2Cord) {
        ...
        var vTitle = 'Объект/Киевгума/1й Цех/Бузулук'+' с '+start.toString()+' по '+end.toString();
...
<script type="text/javascript">
    ...
    function showTrmBody(trmBody){
        ...
        $("#firstCehBuzulukTemperatura").text(tempFormat);
        $("#firstCehBuzulukDavlenie").text(davlenieFormat);
    }
</script>
</body>
</html>
