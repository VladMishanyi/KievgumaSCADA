...
<head>
    ...
    <title>Smesitel5 First Department</title>
    ...
    <div class="container">
        ...
        <table class="table">
            <tr>
                ...
                <th><span id="firstCehSmesitel5Tok" style="color: red; font-family: sans-serif; font-size: 24px;"> </span> А</th>
            </tr>
            <tr>
                <th><span style="color: black; font-family: sans-serif; font-size: 24px;">Реальное значение температуры</span></th>
                <th><span id="firstCehSmesitel5Temp" style="color: red; font-family: sans-serif; font-size: 24px;"> </span> град.</th>
            </tr>
            <tr>
                <th><span style="color: black; font-family: sans-serif; font-size: 24px;">Реальное значение давления</span></th>
                <th><span id="firstCehSmesitel5Pressure" style="color: red; font-family: sans-serif; font-size: 24px;"> </span> бар.</th>
            </tr>
        </table>
        <div class="row">
...
<%--//        var y2 = Array();--%>
        ...
        <%--$.ajax({--%>
            ...
            <%--url: "/generateChartFirstCehSmesitel5KMSF1",--%>
...
<%--//        context.clearShadow();--%>
    ...
    <%--function buildChart(xCord, y1Cord, y2Cord, y3Cord) {--%>
        ...
        <%--var vTitle = 'Объект/Киевгума/1й Цех/Смеситель_5'+' с '+start.toString()+' по '+end.toString();--%>
...
<%--<script type="text/javascript">--%>
    ...
    <%--function connect() {--%>
        ...
        <%--stompClient.connect({}, function(frame) {--%>
            ...
            <%--stompClient.subscribe('/topic/firstCehSmesitel5KMSF1', function(resultTrm){--%>
    ...
    <%--function showTrmBody(trmBody){--%>
        ...
        <%--$("#firstCehSmesitel5Tok").text(temp1);--%>
        <%--$("#firstCehSmesitel5Temp").text(temp2);--%>
        <%--$("#firstCehSmesitel5Pressure").text(temp3);--%>
    <%--}--%>
<%--</script>--%>
<%--<script rel="script" type="text/javascript">--%>
...
<script rel="script" type="text/javascript" src="<c:url value="/resources/js/firstCehSmesitel5KMSF1.js"/>"></script>
</body>
</html>
