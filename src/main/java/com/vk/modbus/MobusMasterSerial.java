...
import com.vk.entity.device.Device;
import com.vk.entity.device.DeviceFirstCehAutoclavTRM202;

/**
 * Created by User on 2018-02-22.
 */
public class MobusMasterSerial {
    private static String port = "COM3";
    private static int baduRate = 115200;
    ...
    private Device device = new DeviceFirstCehAutoclavTRM202();
