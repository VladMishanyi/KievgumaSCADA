...
@Component
@ApplicationScope
public class DeviceModelFirstCehSmesitel3MB110 extends DeviceModel{
    ...
    public DeviceModelFirstCehSmesitel3MB110(){}
    ...
    public static void setDeviceValuesRegister0(float deviceValuesRegister0) {
        DeviceModelFirstCehSmesitel3MB110.deviceValuesRegister0 = deviceValuesRegister0;
    }
    ...
    public static void setHisDeviceValuesRegisters0(float hisDeviceValuesRegisters0) {
        DeviceModelFirstCehSmesitel3MB110.hisDeviceValuesRegisters0 = hisDeviceValuesRegisters0;
    }
    ...
    public static void setDeviceValuesRegister1(float deviceValuesRegister1) {
        DeviceModelFirstCehSmesitel3MB110.deviceValuesRegister1 = deviceValuesRegister1;
    }
    ...
    public static void setHisDeviceValuesRegisters1(float hisDeviceValuesRegisters1) {
        DeviceModelFirstCehSmesitel3MB110.hisDeviceValuesRegisters1 = hisDeviceValuesRegisters1;
    }
