...
public class DeviceModelEnergeticRoomTRM201 extends DeviceModel<Float>{
    ...
    public boolean hysteresis(){
        ...
        for (int i=0; i<getArraySize(); i++){
            ...
            System.out.println("hisDeviceValuesRegisters[i] :"+getHisDeviceValuesRegistersIndex(i));
            System.out.println("deviceValuesRegisters[i] :"+getDeviceValuesRegistersIndex(i));
            System.out.println("hysteresis :"+getHysteresis());
        }
        System.out.println("arraySize :"+getArraySize());
