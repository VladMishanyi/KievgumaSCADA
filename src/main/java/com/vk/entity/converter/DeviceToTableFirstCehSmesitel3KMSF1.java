...
public class DeviceToTableFirstCehSmesitel3KMSF1 extends DeviceToTable<DeviceModelFirstCehSmesitel3KMSF1,
    ...
    public TableModelFirstCehSmesitel3KMSF1 convert(DeviceModelFirstCehSmesitel3KMSF1 deviceModelFirstCehSmesitel3KMSF1,
        ...
        if (ObjectValidator.isNotNull(deviceModelFirstCehSmesitel3KMSF1)){
            ...
            tableModelFirstCehSmesitel3KMSF1.setChannel2(deviceModelFirstCehSmesitel3MB110.getDeviceValuesRegisters()[0]);
            tableModelFirstCehSmesitel3KMSF1.setChannel3(deviceModelFirstCehSmesitel3MB110.getDeviceValuesRegisters()[1]);
        }
