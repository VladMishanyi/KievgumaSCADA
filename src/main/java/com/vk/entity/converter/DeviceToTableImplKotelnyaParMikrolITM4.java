...
public class DeviceToTableImplKotelnyaParMikrolITM4
    ...
    public TableModelKotelnyaParMikrolITM4 convert(DeviceModelKotelnyaParMikrolITM4 deviceModelKotelnyaParMikrolITM4){
        ...
        if (ObjectValidator.isNotNull(deviceModelKotelnyaParMikrolITM4)){
            ...
            tableModelKotelnyaParMikrolITM4.setChannel1(FloatCut.floatTwoDigs(deviceModelKotelnyaParMikrolITM4.getDeviceValuesRegisters()[0]));
            tableModelKotelnyaParMikrolITM4.setChannel2(FloatCut.floatTwoDigs(deviceModelKotelnyaParMikrolITM4.getDeviceValuesRegisters()[1]));
            tableModelKotelnyaParMikrolITM4.setChannel3(FloatCut.floatTwoDigs(deviceModelKotelnyaParMikrolITM4.getDeviceValuesRegisters()[2]));
            tableModelKotelnyaParMikrolITM4.setChannel4(FloatCut.floatTwoDigs(deviceModelKotelnyaParMikrolITM4.getDeviceValuesRegisters()[3]));
        }
