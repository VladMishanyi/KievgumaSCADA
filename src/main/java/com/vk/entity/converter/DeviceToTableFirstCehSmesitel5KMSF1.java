...
public class DeviceToTableFirstCehSmesitel5KMSF1 extends DeviceToTable<DeviceModelFirstCehSmesitel5KMSF1,
    ...
    public TableModelFirstCehSmesitel5KMSF1 convert(DeviceModelFirstCehSmesitel5KMSF1 deviceModelFirstCehSmesitel5KMSF1,
        ...
        if (ObjectValidator.isNotNull(deviceModelFirstCehSmesitel5KMSF1)){
            ...
            tableModelFirstCehSmesitel5KMSF1.setChannel2(deviceModelFirstCehSmesitel5MB110.getDeviceValuesRegisters()[0]);
            tableModelFirstCehSmesitel5KMSF1.setChannel3(deviceModelFirstCehSmesitel5MB110.getDeviceValuesRegisters()[1]);
        }
