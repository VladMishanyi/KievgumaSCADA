...
@Entity
@Table(name = "air_sensor3")
public class TableModelAirSensor3 extends TableModel{
    ...
    public boolean equals(Object object) {
        ...
        if (result){
            TableModelAirSensor3 that = (TableModelAirSensor3) object;
    ...
    @Override
    public TableModelAirSensor3 clone() {
        return (TableModelAirSensor3) super.clone();
    }
}
