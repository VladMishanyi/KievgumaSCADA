...
@Entity
@Table(name = "air_sensor4")
public class TableModelAirSensor4 extends TableModel{
    ...
    public boolean equals(Object object) {
        ...
        if (result){
            TableModelAirSensor4 that = (TableModelAirSensor4) object;
    ...
    @Override
    public TableModelAirSensor4 clone() {
        return (TableModelAirSensor4) super.clone();
    }
}
