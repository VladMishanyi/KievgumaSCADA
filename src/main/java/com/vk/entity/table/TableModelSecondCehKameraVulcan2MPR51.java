 ...
 */
@Entity
@Table(name = "SecondCehKameraVulcan2")
public class TableModelSecondCehKameraVulcan2MPR51 extends TableModel{
    ...
    public TableModelSecondCehKameraVulcan2MPR51(){}
    ...
    public boolean equals(final Object object){
        ...
        if (result){
            TableModelSecondCehKameraVulcan2MPR51 tableModelSecondCehKameraVulcan2MPR51 = (TableModelSecondCehKameraVulcan2MPR51) object;
            result = (this.channel1 == tableModelSecondCehKameraVulcan2MPR51.channel1) &&
                    (this.channel2 == tableModelSecondCehKameraVulcan2MPR51.channel2) &&
                    (this.channel3 == tableModelSecondCehKameraVulcan2MPR51.channel3);
        }
        return result;
    }

    @Override
    public TableModelSecondCehKameraVulcan2MPR51 clone(){
        return (TableModelSecondCehKameraVulcan2MPR51) super.clone();
    }
