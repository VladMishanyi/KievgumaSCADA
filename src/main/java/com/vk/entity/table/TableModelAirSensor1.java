...
@Entity
@Table(name = "air_sensor1")
public class TableModelAirSensor1 extends TableModel{
    ...
    public boolean equals(Object object) {
        ...
        if (result){
            TableModelAirSensor1 that = (TableModelAirSensor1) object;
    ...
    @Override
    public TableModelAirSensor1 clone() {
        return (TableModelAirSensor1) super.clone();
    }
}
