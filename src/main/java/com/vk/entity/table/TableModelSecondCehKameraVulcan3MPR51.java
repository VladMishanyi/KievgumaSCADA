 ...
 */
@Entity
@Table(name = "SecondCehKameraVulcan3")
public class TableModelSecondCehKameraVulcan3MPR51 extends TableModel{
    ...
    public TableModelSecondCehKameraVulcan3MPR51(){}
    ...
    public boolean equals(final Object object){
        ...
        if (result){
            TableModelSecondCehKameraVulcan3MPR51 tableModelSecondCehKameraVulcan3MPR51 = (TableModelSecondCehKameraVulcan3MPR51) object;
            result = (this.channel1 == tableModelSecondCehKameraVulcan3MPR51.channel1) &&
                    (this.channel2 == tableModelSecondCehKameraVulcan3MPR51.channel2) &&
                    (this.channel3 == tableModelSecondCehKameraVulcan3MPR51.channel3);
        }
        return result;
    }

    @Override
    public TableModelSecondCehKameraVulcan3MPR51 clone(){
        return (TableModelSecondCehKameraVulcan3MPR51) super.clone();
    }
