...
public class JsonControllerSecondCehKameraVulcan2MPR51 extends JsonController<DeviceModelSecondCehKameraVulcan2MPR51, SecondCehKameraVulcan2MPR51ServiceData, TableModelSecondCehKameraVulcan2MPR51> {
    ...
    public List<TableModelSecondCehKameraVulcan2MPR51> generateChartSecondCehKameraVulcan2MPR51(final JsonBodyLocalDateTimeFromChart dateFromChart){
    ...
    public void writeSteamPwm(final JsonBodyFloat jsonBodyFloat, Authentication authentication){
        ...
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_steam_pwm: "+val));
    ...
    public void writeSteamKi(final JsonBodyFloat jsonBodyFloat, Authentication authentication){
        float val = jsonBodyFloat.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_steam_ki: "+val));
    ...
    public void writeSteamKp(final JsonBodyFloat jsonBodyFloat, Authentication authentication){
        float val = jsonBodyFloat.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_steam_kp: "+val));
    ...
    public void writeSteamKd(final JsonBodyFloat jsonBodyFloat, Authentication authentication){
        float val = jsonBodyFloat.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_steam_kd: "+val));
    ...
    public void writeElectricPwm(final JsonBodyFloat jsonBodyFloat, Authentication authentication){
        float val = jsonBodyFloat.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_electric_pwm: "+val));
    ...
    public void writeElectricKi(final JsonBodyFloat jsonBodyFloat, Authentication authentication){
        float val = jsonBodyFloat.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_electric_ki: "+val));
    ...
    public void writeElectricKp(final JsonBodyFloat jsonBodyFloat, Authentication authentication){
        float val = jsonBodyFloat.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_electric_kp: "+val));
    ...
    public void writeElectricKd(final JsonBodyFloat jsonBodyFloat, Authentication authentication){
        float val = jsonBodyFloat.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_electric_kd: "+val));
    ...
    public void writeAlarm(final JsonBodyFloat jsonBodyFloat, Authentication authentication){
        float val = jsonBodyFloat.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_alarm: "+val));
    ...
    public void writeRegim1(final JsonBodyShort jsonBodyShort, Authentication authentication){
        ...
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_regim1: "+val));
    ...
    public void writeTemp1(final JsonBodyFloat jsonBodyFloat, Authentication authentication){
        float val = jsonBodyFloat.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_temp1: "+val));
    ...
    public void writePress1(final JsonBodyFloat jsonBodyFloat, Authentication authentication){
        float val = jsonBodyFloat.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_press1: "+val));
    ...
    public void writeRegim2(final JsonBodyShort jsonBodyShort, Authentication authentication){
        short val = jsonBodyShort.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_regim2: "+val));
    ...
    public void writeTemp2(final JsonBodyFloat jsonBodyFloat, Authentication authentication){
        float val = jsonBodyFloat.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_temp2: "+val));
    ...
    public void writePress2(final JsonBodyFloat jsonBodyFloat, Authentication authentication){
        float val = jsonBodyFloat.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_press2: "+val));
    ...
    public void writeRegim3(final JsonBodyShort jsonBodyShort, Authentication authentication){
        short val = jsonBodyShort.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_regim3: "+val));
    ...
    public void writeTemp3(final JsonBodyFloat jsonBodyFloat, Authentication authentication){
        float val = jsonBodyFloat.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_temp3: "+val));
    ...
    public void writePress3(final JsonBodyFloat jsonBodyFloat, Authentication authentication){
        float val = jsonBodyFloat.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_press3: "+val));
    ...
    public void writeRegim4(final JsonBodyShort jsonBodyShort, Authentication authentication){
        short val = jsonBodyShort.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_regim4: "+val));
    ...
    public void writeTemp4(final JsonBodyFloat jsonBodyFloat, Authentication authentication){
        float val = jsonBodyFloat.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_temp4: "+val));
    ...
    public void writePress4(final JsonBodyFloat jsonBodyFloat, Authentication authentication){
        float val = jsonBodyFloat.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_press4: "+val));
    ...
    public void writeRegim5(final JsonBodyShort jsonBodyShort, Authentication authentication){
        short val = jsonBodyShort.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_regim5: "+val));
    ...
    public void writeTemp5(final JsonBodyFloat jsonBodyFloat, Authentication authentication){
        float val = jsonBodyFloat.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_temp5: "+val));
    ...
    public void writePress5(final JsonBodyFloat jsonBodyFloat, Authentication authentication){
        float val = jsonBodyFloat.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_press5: "+val));
    ...
    public void writeRegim6(final JsonBodyShort jsonBodyShort, Authentication authentication){
        short val = jsonBodyShort.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_regim6: "+val));
    ...
    public void writeTemp6(final JsonBodyFloat jsonBodyFloat, Authentication authentication){
        float val = jsonBodyFloat.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_temp6: "+val));
    ...
    public void writePress6(final JsonBodyFloat jsonBodyFloat, Authentication authentication){
        float val = jsonBodyFloat.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_press6: "+val));
    ...
    public void writeRegim7(final JsonBodyShort jsonBodyShort, Authentication authentication){
        short val = jsonBodyShort.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_regim7: "+val));
    ...
    public void writeTemp7(final JsonBodyFloat jsonBodyFloat, Authentication authentication){
        float val = jsonBodyFloat.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_temp7: "+val));
    ...
    public void writePress7(final JsonBodyFloat jsonBodyFloat, Authentication authentication){
        float val = jsonBodyFloat.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_press7: "+val));
    ...
    public void writeRegim8(final JsonBodyShort jsonBodyShort, Authentication authentication){
        short val = jsonBodyShort.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_regim8: "+val));
    ...
    public void writeTemp8(final JsonBodyFloat jsonBodyFloat, Authentication authentication){
        float val = jsonBodyFloat.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_temp8: "+val));
    ...
    public void writePress8(final JsonBodyFloat jsonBodyFloat, Authentication authentication){
        float val = jsonBodyFloat.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_press8: "+val));
    ...
    public void writeRegim9(final JsonBodyShort jsonBodyShort, Authentication authentication){
        short val = jsonBodyShort.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_regim9: "+val));
    ...
    public void writeTemp9(final JsonBodyFloat jsonBodyFloat, Authentication authentication){
        float val = jsonBodyFloat.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_temp9: "+val));
    ...
    public void writePress9(final JsonBodyFloat jsonBodyFloat, Authentication authentication){
        float val = jsonBodyFloat.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_press9: "+val));
    ...
    public void writeRegim10(final JsonBodyShort jsonBodyShort, Authentication authentication){
        short val = jsonBodyShort.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_regim10: "+val));
    ...
    public void writeTemp10(final JsonBodyFloat jsonBodyFloat, Authentication authentication){
        float val = jsonBodyFloat.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_temp10: "+val));
    ...
    public void writePress10(final JsonBodyFloat jsonBodyFloat, Authentication authentication){
        float val = jsonBodyFloat.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_press10: "+val));
    ...
    public void writeRegim11(final JsonBodyShort jsonBodyShort, Authentication authentication){
        short val = jsonBodyShort.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_regim11: "+val));
    ...
    public void writeTemp11(final JsonBodyFloat jsonBodyFloat, Authentication authentication){
        float val = jsonBodyFloat.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_temp11: "+val));
    ...
    public void writePress11(final JsonBodyFloat jsonBodyFloat, Authentication authentication){
        float val = jsonBodyFloat.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_press11: "+val));
    ...
    public void writeRegim12(final JsonBodyShort jsonBodyShort, Authentication authentication){
        short val = jsonBodyShort.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_regim12: "+val));
    ...
    public void writeTemp12(final JsonBodyFloat jsonBodyFloat, Authentication authentication){
        float val = jsonBodyFloat.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_temp12: "+val));
    ...
    public void writePress12(final JsonBodyFloat jsonBodyFloat, Authentication authentication){
        float val = jsonBodyFloat.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_press12: "+val));
    ...
    public void writeProgram(final JsonBodyShort jsonBodyShort, Authentication authentication){
        short val = jsonBodyShort.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_program: "+val));
    ...
    public void writeProgramRead(final JsonBodyShort jsonBodyShort, Authentication authentication){
        short val = jsonBodyShort.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_program_read: "+val));
    ...
    public void write_program_write(final JsonBodyShort jsonBodyShort, Authentication authentication){
        short val = jsonBodyShort.getValue();
        loggerService.addByType(new TableModelLogger(LocalDateTime.now(), authentication.getName(), "/second_ceh_kamera_vulcan2_MPR51/write_program_write: "+val));
