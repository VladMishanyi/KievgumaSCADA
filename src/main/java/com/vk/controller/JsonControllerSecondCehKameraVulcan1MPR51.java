...
public class JsonControllerSecondCehKameraVulcan1MPR51 extends JsonController {

    private Logger LOGGER = Logger.getLogger(JsonControllerSecondCehKameraVulcan1MPR51.class);
